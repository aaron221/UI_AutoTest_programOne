...
// * 从首页点击当日呼入电话大图标进入当日呼出电话统计页面
// */
//public class GoToOutcallPage {
...
//        Log.startTestCase("点击当日呼出电话大图标");
//        try {
//            driver = driver.switchTo().frame(Constant.SENCOND_IFRAME);
//            DriverWait.findElement(driver, driver.findElement(By.xpath("//dd[@id='phoneCallOutDd']/p"))).click();//点击当日呼出电话
//            Thread.sleep(1000);
